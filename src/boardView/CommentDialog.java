...
import boardView.BoardApp.EvenOddRenderer;
...
public class CommentDialog extends JDialog{
	private JPanel pContent,pSouth, boardArea,pNorth,pBackground;
    ...
    public CommentDialog(BoardApp boardApp, int boardNo,String email) {
...
//			commentButton.setFont(myFont1);
			...
			commentButton.setBounds(600,140,100,50);
